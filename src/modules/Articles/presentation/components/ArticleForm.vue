...
const draftRef =
  !route.params.id && localStorage.getItem('article-draft')
    ? CustomToast()
    : null;
        ...
        <AccordionContent>
          ...
          <div class="document-tab">
            <div class="form-group">
              ...
              <div class="input">
                <div class="input">
                  <UpdatedCustomInputSelect id="question-sequence" v-model="SelectedQuestionSequence" :label="`subject`"
                    :static-options="subjectOptions" placeholder="select subject"
        ...
        <AccordionContent>
          <div class="input-wrapper">
            ...
            <div class="description-container">
              <div class="description-header">
                <span>B / U</span>
                <HandleFilesUpload :label="``" accept="image/*" :hidepreview="true" :max-files="1" :multiple="true"
                  :index="2" :file="explanationAttachments" :have-content="true" :class="`image-input`"
              ...
              <div class="preview-container">
                <div v-if="explanationAttachments?.length" class="preview-grid">
                  <div class="preview-item">
                    ...
                    <button type="button" class="remove-btn" title="Remove" @click.stop="handleExplanationAttachments">
                      ✕
                    </button>
                  </div>
                </div>
