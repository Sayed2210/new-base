...
const headers: TableHeader[] = [
  ...
  { key: 'article_title', label: 'article title', width: '30%' },
  { key: 'subject', label: 'subject', width: '15%' },
  { key: 'generated_by', label: 'generated by', width: '15%' },
  { key: 'no_of_qs', label: 'No of Qs', width: '15%' },
];
    ...
    <DataStatusBuilder :controller="state" :on-retry="async () => await fetchArticles()">
      <template #success="{ data }">
        <div class="table-frame">
          <AppTable :headers="headers" :items="data as ShowArticleModel[]" :hoverable="true" :striped="true" show-index>
            ...
            <template #actions="{ item }">
              <div class="row-actions">
                ...
                <router-link :to="`/${route.params.country_code}/articles/edit/${item.id}`" title="show"
