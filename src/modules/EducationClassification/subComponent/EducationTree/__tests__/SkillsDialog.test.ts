...
const mockEducationSkillsController = {
  fetchList: vi.fn().mockResolvedValue({ data: [] }),
...
vi.mock('../../presentation/controllers/EducationSkills/education.skills.controller', () => ({
  default: {
    getInstance: () => mockEducationSkillsController,
  },
}));

vi.mock('@/modules/Skills/presentation/controllers/skills.controller', () => ({
  default: {
    getInstance: () => mockSkillsController,
  },
}));
...
describe('SkillsDialog', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mockEducationSkillsController.listState.value = { data: [] };
  });

  it('renders when visible', () => {
    const wrapper = mount(SkillsDialog, { props: defaultProps, global: globalConfig });
    expect(wrapper.find('.dialog-stub').exists()).toBe(true);
  });

  it('renders percentage input', () => {
    const wrapper = mount(SkillsDialog, { props: defaultProps, global: globalConfig });
