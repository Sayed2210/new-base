...
export const STATIC_TEST_DATA = {
    users: [
        { id: 1, name: 'John Doe', email: 'john@example.com', avatar: '', role: 'admin', status: 'active' as const },
        { id: 2, name: 'Jane Smith', email: 'jane@example.com', avatar: '', role: 'user', status: 'active' as const },
        { id: 3, name: 'Bob Wilson', email: 'bob@example.com', avatar: '', role: 'manager', status: 'inactive' as const },
    ],

    products: [
        { id: 1, name: 'Laptop', description: 'High-performance laptop', price: 999, stock: 50, category: 'Electronics', image: '', rating: 4.5 },
        { id: 2, name: 'Headphones', description: 'Wireless headphones', price: 199, stock: 100, category: 'Electronics', image: '', rating: 4.2 },
        { id: 3, name: 'T-Shirt', description: 'Cotton t-shirt', price: 29, stock: 200, category: 'Clothing', image: '', rating: 4.0 },
    ],

    equipment: [
        { id: 1, title: 'Excavator', subtitle: 'Heavy duty', has_certificate: 1, all_industries: 0, industries: [{ id: 2, title: 'Construction' }], parent_id: null, image: '', titles: 'Excavator - Heavy', equipment_type: { id: 1, title: 'Heavy Machinery' } },
        { id: 2, title: 'Drill', subtitle: 'Power drill', has_certificate: 0, all_industries: 1, industries: [], parent_id: null, image: '', titles: 'Drill - Power', equipment_type: { id: 2, title: 'Power Tools' } },
    ],
};
